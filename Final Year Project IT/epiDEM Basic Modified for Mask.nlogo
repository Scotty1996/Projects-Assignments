...
to go
  if all? turtles [ not infected? ]
     [ export-all-plots "C:/Users/Scott/Desktop/ProjectData Mask/Test.csv"
        stop ]
...
to calculate-r0
  ...
  let susceptible-t
   (initial-people + initial-people-mask) -
    count turtles with [ infected? ] -
  ...
  if(initial-people + initial-people-mask) - susceptible-t != 0 and susceptible-t != 0
  [
    ;; This is derived from integrating dI / dS = (beta*SI - gamma*I) / (-beta*SI):
    set r0 (ln (s0 / susceptible-t) /((initial-people + initial-people-mask) - susceptible-t))
...
@#$#@#$#@
<experiments>
  <experiment name="Run100NonMask" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="Run50_50NonMaskToMask" repetitions="100" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
  ...
  <experiment name="Run100Mask" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
  ...
  <experiment name="Run75Mask_25NonMaskToMask" repetitions="100" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
  ...
  <experiment name="Run25Mask_75NonMaskToMask" repetitions="100" sequentialRunOrder="false" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
