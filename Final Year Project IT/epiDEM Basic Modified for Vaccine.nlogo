...
;; Based on above sources, SARS infection has an average r0 of 1.2233 amd range of 0.19-2.4.
...
to go
  if all? turtles [ not infected? ]
    [ export-all-plots "C:/Users/Scott/Desktop/ProjectData Vaccine/Test.csv"
        stop ]
  ...
  let nearby-uninfected (turtles-on neighbors)
    ...
    if nearby-uninfected != nobody
     [ ask nearby-uninfected
       [ if vaccine? = false
        [ if random-float 100 > infection-chance ;; Infect no mask-mask true
         [ set infected? true
...
to calculate-r0
  ...
  let susceptible-t
   (initial-people + initial-people-vaccine) -
    count turtles with [ infected? ] -
  ...
  if(initial-people + initial-people-vaccine) - susceptible-t != 0 and susceptible-t != 0
  [
    ;; This is derived from integrating dI / dS = (beta*SI - gamma*I) / (-beta*SI):
    set r0 (ln (s0 / susceptible-t) /((initial-people + initial-people-vaccine) - susceptible-t))
...
1643
766
Cumulative percentages of non Vaccinated-Population
Days
% Total Population
0.0
10.0
...
"" ""
PENS
"% of total infected" 1.0 0 -2674135 true "" "plot (((count turtles with [ infected? and not vaccine? ]) / (initial-people)) * 100)"
"% of total non infected" 1.0 0 -10899396 true "" "plot ((count turtles with [ not infected? and not vaccine? ] / (initial-people)) * 100)"
"% of cured - non infected" 1.0 0 -13345367 true "" "plot ((count turtles with [ cured? and not vaccine? ] / (initial-people)) * 100)"
"% of uninfected - non infected" 1.0 0 -16777216 true "" "plot ((count turtles with [ not cured? and not vaccine? ] / (initial-people)) * 100)"
...
"" ""
PENS
"% of total infected " 1.0 0 -2674135 true "" "plot (((count turtles with [ infected? ]) / (initial-people + initial-people-vaccine)) * 100)"
"% of total non infected" 1.0 0 -10899396 true "" "plot ((count turtles with [ not infected? ] / (initial-people + initial-people-vaccine)) * 100)"
"% of cured - non infected" 1.0 0 -13345367 true "" "plot ((count turtles with [ cured? ] / (initial-people + initial-people-vaccine)) * 100)"
"% of uninfected - non infected" 1.0 0 -16777216 true "" "plot ((count turtles with [ not cured? ] / (initial-people + initial-people-vaccine)) * 100)"
...
1642
457
Cumulative percentages of vaccinated-Population
Days
% Total Population
0.0
10.0
...
@#$#@#$#@
<experiments>
  <experiment name="NoVaccine" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
  ...
  <experiment name="25Vaccine" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
  ...
  <experiment name="50Vaccine" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
  ...
  <experiment name="75Vaccine" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
  ...
  <experiment name="85Vaccines" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
  ...
  <experiment name="90vaccines" repetitions="100" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count turtles</metric>
    <metric>r0</metric>
